...
class TestQuality(unittest.TestCase):
    ...
    def test_str_for_groups(self):
        ...
        q = quality.for_table([[a, b, c], [a, None, c]], 7)
        ...
        # With no unplaced
        q = quality.for_table([[a, b, c], [a, None, c]], 0)
    ...
    def test_compatibility(self):
        ...
        c = quality.for_decoration()
        d = quality.for_table([[a, b, c], [a, None, b]], 7)
        e = quality.for_table([[a, b, c], [b, None, None]], 8)
...
class TestQualityComparisonForGroups(unittest.TestCase):
    ...
    def test_adding_decoration_changes_nothing(self):
        ...
        cols1 = quality.for_table([[a, b, a], [b, b, b]], 3)
        cols2 = quality.for_table([[a, c, b, a], [b, b, b, c]], 3)
        self.assertAlmostEqual(cols1.minor_score(), cols2.minor_score())

        cols1 = quality.for_columns([50, 75], [[a, b, a], [b, b, b]], 3)
        cols2 = quality.for_columns([50, 75], [[a, c, b, a], [b, b, b, c]], 3)
        self.assertAlmostEqual(cols1.minor_score(), cols2.minor_score())
    ...
    def test_aggregation(self):
        ...
        q = quality.for_table([[a, b, a, c], [a, d, c, e]], 3)
        ...
        q = quality.for_columns([50, 70], [[a, b, a, c], [a, d, c, e]], 3)
        self.assertEqual(1, q.excess_ss)
        self.assertAlmostEqual(3, q.image_shrinkage, places=2)
        self.assertEqual(12, q.bad_breaks)
        self.assertEqual(8, q.good_breaks)
    ...
    def test_aggregation_of_aggregations(self):
        ...
        t1 = quality.for_table([[a, b], [a, c]], 3)
        t2 = quality.for_table([[d, e], [b, b]], 7)

        q = quality.for_columns([50, 70], [[t1, t1], [t1, t2]], 3)
    ...
    def test_image_versus_wrapping(self):
        ...
        self.assertEqual(0, quality.for_table([[perfect_image], [perfect_text]], 3).minor_score())

        a = quality.for_table([[perfect_image], [no_break_10_excess]], 3)
        b = quality.for_table([[slightly_shrunk_image], [perfect_text]], 3)
        c = quality.for_table([[slightly_shrunk_image], [no_break_20_excess]], 3)
        d = quality.for_table([[perfect_image], [bad_break_no_excess]], 3)
        e = quality.for_table([[half_image], [perfect_text]], 3)
        f = quality.for_table([[bad_break_no_excess], [bad_break_no_excess]], 3)
